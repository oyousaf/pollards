    ...
    <div name="info" className="w-full h-screen bg-[#9f34b5] text-gray-300">
        <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
            ...
            <div className="area w-full justify-center items-center grid md:grid-cols-3 gap-8">
              ...
              <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-md shadow-blue-700 
              ...
              <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-md shadow-blue-700 hover:scale-110 
