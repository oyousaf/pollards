    ...
    >
      ...
      <div className={`${styles.flexStart} mb-8 pt-6 w-full`}>
        <div className="flex-1 flex flex-col justify-center items-center">
          ...
          {showScroll && (
            <button
              className="bg-[#C3B1E1] text-[#002D04] hover:text-white text-2xl md:text-4xl p-2 rounded-full transition-all ease-in duration-300 fixed bottom-7 right-7 z-50"
              onClick={scrollToTop}
            >
              <FaArrowUp />
            </button>
