    ...
    >
      ...
      <div className={`${styles.flexStart} mb-8 pt-6 w-full`}>
        <div className="flex-1 flex flex-col justify-center items-center">
            ...
            <p className="flex flex-row">
              {socialMedia.map((social, index) => (
                <a
                  ...
                  title={social.id}
                  className={`text-3xl text-white hover:text-[#C3B1E1] object-contain cursor-pointer ${
          ...
          {showScroll && (
            <button
              className="bg-[#C3B1E1] text-primary hover:text-white text-2xl md:text-4xl p-2 rounded-full transition-all ease-in duration-300 fixed bottom-7 right-7 z-50"
              onClick={scrollToTop}
            >
              <FaArrowUp />
            </button>
